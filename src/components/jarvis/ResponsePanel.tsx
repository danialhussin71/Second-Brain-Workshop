...
export default function ResponsePanel({ state }: { state: JarvisRunState }) {
  ...
  const [selected, setSelected] = useState<"carousel" | "reel" | "longform" | "briefing" | null>(null);
